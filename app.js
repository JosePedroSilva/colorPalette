...
function colorizeSliders(color, hue, brightness, saturation) {
	// Scale saturation
	const noSat = color.set("hsl.s", 0); //prettier-ignore
	const fullSat = color.set("hsl.s", 1); //prettier-ignore
...
function savePalette(e) {
	...
	const palettebBtn = document.createElement('button');
	palettebBtn.classList.add('pick-palette-btn');
	palettebBtn.classList.add(paletteObj.nr);
	palettebBtn.innerText = 'Select';

	//Attach event to button
	palettebBtn.addEventListener('click', e => {
		closeLibrary();
	...
	palette.appendChild(palettebBtn);
